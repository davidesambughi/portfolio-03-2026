        ...
        {PROJECTS.map(({ icon: Icon, hue, title, slug, description, tags, status, image, alt, url }, index) => {
          ...
          return (
            <motion.article
              ...
              className={[
                'group rounded-2xl overflow-hidden bg-card cursor-pointer outline-none',
                'border transition-all duration-300 focus-visible:ring-2 focus-visible:ring-primary/50',
                isSelected
            ...
            >
              ...
              <div className="flex min-h-[180px]">
                    ...
                    {tags.map(tag => (
                      <span
                        ...
                        className={cn(
                          ...
                          "rounded-full font-medium border-border text-muted-foreground group-hover:border-primary/25 transition-colors duration-200"
                        )}
                      >
                        {tag}
                      </span>
                ...
                {/* Right: screenshot */}
                <div className="w-[38%] shrink-0 border-l border-border relative overflow-hidden bg-muted/5 min-h-[230px]">
                  {image ? (
                    <motion.div 
